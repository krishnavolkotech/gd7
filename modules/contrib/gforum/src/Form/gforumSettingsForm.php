...
class GforumSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['integration']['containers_field_machine_name'] = array(
      '#type' => 'textfield',
    ...
    $form['integration']['group_forum_access_perm'] = array(
      '#type' => 'textfield',
    ...
    $form['integration']['taxonomy_term_redirect'] = array(
      '#type' => 'checkbox',
    ...
    $form['ui']['remove_core_create_ui'] = array(
      '#type' => 'checkbox',
    ...
    $form['ui']['remove_core_create_disallowed_message'] = array(
      '#type' => 'checkbox',
    ...
    $form['ui']['topic_create_help'] = array(
      '#type' => 'textfield',
      ...
      '#states' => array(
        'visible' => array(
          ':input[name="remove_core_create_disallowed_message"]' => array('checked' => TRUE),
        ),
      ),
    );
