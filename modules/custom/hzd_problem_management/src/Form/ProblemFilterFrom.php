...
class ProblemFilterFrom extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state, $type = NULL, $default_limit = NULL) {
         ...
         * filter.
         */
        $default_services[0] = '<' . t("Select Service") . '>';
        ...
        // default releases
        $default_release[0] = '<' . t("Select Release") . '>';
...
//      '#validated' => TRUE,
        ...
        if(isset($filter_value['function']) && $filter_value['function'] != 0 && !in_array($filter_value['function'],$default_function)){
...
//    ['service']: $form_state->getValue('service');
      if(isset($filter_value['release']) && $filter_value['release'] != 0 && !in_array($filter_value['release'],$default_release)){
