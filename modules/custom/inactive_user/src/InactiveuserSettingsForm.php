...
//    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    \Drupal::configFactory()->getEditable('inactive_user.settings')
      ...
      ->set('inactive_user_notify_mail_subject', $form_state->getValue('inactive_user_notify_mail_subject'))
      ->set('inactive_user_block_mail_subject', $form_state->getValue('inactive_user_block_mail_subject'))
      ->set('inactive_user_block_warn_mail_subject', $form_state->getValue('inactive_user_block_warn_mail_subject'))
