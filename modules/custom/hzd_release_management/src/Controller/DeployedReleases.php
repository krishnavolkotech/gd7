...
/**
 * @file
 * Contains \Drupal\hzd_release_management\Controller
 */
...
class DeployedReleases extends ControllerBase {
  ...
  function display_deployed_release_table() {
    ...
    $services = db_query("SELECT nfd.title FROM node_field_data nfd
      ...
      WHERE grv.group_id = 339 AND nrt.release_type_target_id = 459 AND nfd.status = 1 AND nfd.type = 'services' AND nfrn.field_release_name_value 
